...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td>
                <%= Html.ActionLink("编辑", "Edit", new { ArticleID = item.ArticleID, TypeID = ViewData["TypeID"] })%> |
                <%= Html.ActionLink("查看", "Details", new { ArticleID = item.ArticleID })%> |
                <%= Html.ActionLink("删除", "Delete", new { ArticleID = item.ArticleID })%>
            </td>
            <td>
